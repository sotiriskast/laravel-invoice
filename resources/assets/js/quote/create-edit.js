...
function initializeSelect2CreateEditQuote () {
    ...
    let editQuoteDueDateFlatPicker = $('#editQuoteDueDate').flatpickr({
        dateFormat: currentDateFormat,
        defaultDate: moment($('#editQuoteDueDate').val()).format(momentFormat),
        "locale": getUserLanguages,
    });
    ...
    $('#quote_date').flatpickr({
        ...
        onChange: function (selectedDates, dateStr, instance) {
            let minDate = moment($('#quote_date').val(), momentFormat).
            add(1, 'days').
            format(momentFormat);
    ...
    $('#editQuoteDate').flatpickr({
        dateFormat: currentDateFormat,
        defaultDate: moment($('#editQuoteDate').val()).format(momentFormat),
        "locale": getUserLanguages,
        onChange: function () {
            let minDate = moment($('#editQuoteDate').val(),momentFormat).
            add(1, 'days').
            format(momentFormat);
