    ...
    <div class="mb-0">
        <div class="row gx-10 mb-5">
            ...
            <div class="mb-5 col-lg-6 col-sm-12 recurring-cycle-content">
                ...
                {{ Form::number('recurring_cycle', $invoice->recurring_cycle, ['class' => 'form-control', 'id' => 'recurringCycle', 'autocomplete' => 'off', 'placeholder'=>'Enter number of Days for Recurring Cycle']) }}
            </div>
        </div>
    </div>
    <div class="mb-0">
