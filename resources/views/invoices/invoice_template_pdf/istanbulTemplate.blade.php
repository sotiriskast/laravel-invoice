...
<table width="100%">
    <tr>
        <td {{ $styleCss }}="background: {{ $invoice_template_color }}; color: white">
        <div class="main-heading ml-4" {{ $styleCss }}="font-size: 40px">INVOICE</div>
        </td>
        <td width="250px" {{ $styleCss }}="padding-left: 20px">
            <div class="logo">
