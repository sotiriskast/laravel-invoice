                                        ...
                                        <table class="table table-striped box-shadow-none mt-4">
                                            ...
                                            @foreach($invoice->invoiceItems as $index => $invoiceItem)
                                                <tr>
                                                    ...
                                                    <td class="py-4 text-end">{{  isset($invoiceItem->price) ? getInvoiceCurrencyAmount($invoiceItem->price,$invoice->currency_id,true) : 'N/A' }}</td>
                                                    ...
                                                    <td class="py-4 text-end">{{ isset($invoiceItem->total) ? getInvoiceCurrencyAmount($invoiceItem->total,$invoice->currency_id,true) : 'N/A' }}</td>
                                                </tr>
                                            @endforeach
                                            </tbody>
                                        </table>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-gray-900 text-end pe-0">
                                                        ...
                                                        @else
                                                            ...
                                                            @else
                                                                {{ getInvoiceCurrencyAmount($invoice->amount * $invoice->discount / 100,$invoice->currency_id,true)}}
                                                            @endif
                                                        @endif
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td class="text-gray-900 text-end pe-0">
                                                        {!!   (numberFormat(array_sum($totalTax)) != 0 )
                                                          ? getInvoiceCurrencyAmount(array_sum($totalTax),$invoice->currency_id,true) :'N/A' !!}
                                                    </td>
                                                </tr>
                                                <tr>
