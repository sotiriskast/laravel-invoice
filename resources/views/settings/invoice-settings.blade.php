        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-sm-6 mb-5">
                        {{ Form::label('currency_after_amount', __('messages.setting.currency_position').':', ['class' => 'form-label required fw-bolder mb-3']) }}
                    ...
                    <div class="form-group col-sm-6 mb-5">
                        {{ Form::label('Invoice No Prefix', __('messages.setting.invoice_no_prefix').':', ['class' => 'form-label fs-6 fw-bolder text-gray-700 mb-3']) }}
                    ...
                    <div class="form-group col-sm-6 mb-5">
                        {{ Form::label('Invoice No Suffix', __('messages.setting.invoice_no_suffix').':', ['class' => 'form-label fs-6 fw-bolder text-gray-700 mb-3']) }}
