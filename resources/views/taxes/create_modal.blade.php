            ...
            <div class="modal-body scroll-y">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-sm-12 mb-5">
                        ...
                        {{ Form::number('value', null, ['id'=>'value','class' => 'form-control form-control-solid','oninput'=>"validity.valid||(value=value.replace(/[e\+\-]/gi,''))",'min'=>'0','value'=>'0','step'=>'.01', 'required','placeholder' => __('messages.common.value')]) }}
                    </div>
                    <div class="form-group col-sm-12 mb-5">
                        ...
                        <div class="form-check form-check-custom ">
                            <div class="btn-group">
                                ...
                                <input class="form-check-input mx-2" type="radio" name="is_default" value="0" checked/>
                                <label class="form-check-label">
                                    {{ __('messages.tax.no').':' }}
                                </label>
                            </div>
