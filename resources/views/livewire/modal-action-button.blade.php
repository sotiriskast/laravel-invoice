<div class="d-flex justify-content-center">
    ...
    <a title="{{__('messages.common.delete')}}" href="javascript:void(0)" data-bs-toggle="tooltip" data-id="{{ $dataId }}"
       class="faq-delete-btn btn px-2 text-danger fs-3 py-2 {{ $deleteClass ?? '' }}">
