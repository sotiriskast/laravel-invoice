        ...
        <div class="card-body">
            <div class="tab-content" id="myTabContent">
                <div class="tab-pane fade show active" id="overview" role="tabpanel" aria-labelledby="overview-tab">
                    <div class="row">
                        <div class="col-sm-6 d-flex flex-column mb-md-10 mb-5 {{ empty($user->contact) ? 'd-none' : ''}}">
                        ...
                        <div class="col-sm-6 d-flex flex-column mb-md-10 mb-5">
                            ...
                            <span class="fs-4 text-gray-800">{{\Carbon\Carbon::parse($user->created_at)->translatedFormat('jS \of F Y')}}</span>
                        </div>
