                ...
                <div class="card-body pt-5">
                    <div class="row">
                        <div class="col-lg-12 mb-5">
                            ...
                            <div class="fw-bolder text-gray-800 fs-6">{!! $quote->note ?? __('messages.quote.note_not_found') !!}</div>
                        </div>
                        <div class="col-lg-12 mb-5">
                            <div class="fw-bold text-gray-600 fs-7">{{ __('messages.quote.terms').':' }}</div>
                            <div
                                class="fw-bolder text-gray-800 fs-6">{!! $quote->term ?? __('messages.quote.terms_not_found') !!}</div>
                        </div>
                    </div>
                </div>
            </div>
